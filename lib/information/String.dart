class Strings{
  ...
  static const String APP_NAME = "Gezegen Rehberi";

  static const List<String> GEZEGEN_ADLARI = [
    "MERKUR",
    "VENUS",
    "DUNYA",
    "MARS",
  ...
  static const List<String> GEZEGENLER_GENEL_OZELLIKLERI = [
    ...
    "\tGüneş’in etrafındaki yörünge turunu hızlı tamamlamasından dolayı ismini Antik Roma mitolojisinde “Haberci Tanrısı” olarak bilinen Merkür’den almaktadır.\n\n"
    ...
    "\tDiğer gezegenlerin tamamı aynı yöne doğru dönerken Venüs ters bir yörünge çizmektedir.\n\n"
    ...
    "\tVenüs’ün eksen eğimi bulunmadığı için Venüs’te mevsimler yoktur.\n\n",
    ...
    "\tDünya’mız kutuplardan basık ekvatordan ise şişkin bir yapıya sahiptir.\n\n"
    ...
    "\tDünya ile benzer özellikler göstermesinden dolayı Mars’ta yaşam olabileceğine dair çok sayıda teori vardır.\n\n"
    "\tTıpkı Dünya gibi yıl içerisinde güneşe yaklaşır ve uzaklaşır.\n\n"
    "\tBugüne kadar en çok uzay aracı gönderilen gezegendir.\n\n",


    "\tGenel Özellikler\n\n"
    "\tGüneşe en yakın beşinci gezegendir.\n\n"
    "\tBüyüklüğünden dolayı ismini Antik Roma’da “Tanrıların Kralı” olarak bilinen Jüpiter’den almıştır.\n\n"
